            ...
            <nav className="navbar">
                <div className="navbar-brand">
                    ...
                    <div>
                        ...
                        <small>Internal Marks Management</small>
                    </div>
                </div>
...
export default function TeacherDashboard() {
    ...
    const handleMarkChange = (student_id, subject_id, val) => {
        ...
        setLocalMarks(m => ({ ...m, [key]: val.toUpperCase() }))
    }
                                                ...
                                                >
                                                    {
                                                        subjects.map((s, index) => {
                                                            ...
                                                            return <cell key={`cell-${index}`} fill={pct >= 50 ? 'var(--primary)' : 'var(--danger-light)'} />;
                                                        })
                                                    }
                                                </Bar>
                                            </BarChart>
                                    ...
                                    <div style={{ width: '100%', height: 450 }}>
                                        <ResponsiveContainer width="100%" height="100%">
                                            ...
                                            >
                                                ...
                                                <Bar dataKey="< 50%" stackId="a" fill="#ef4444" radius={[0, 0, 0, 0]} />
                                                <Bar dataKey="50-60%" stackId="a" fill="#f59e0b" radius={[0, 0, 0, 0]} />
                                                <Bar dataKey="60-70%" stackId="a" fill="#eab308" radius={[0, 0, 0, 0]} />
                                                <Bar dataKey="70-80%" stackId="a" fill="#84cc16" radius={[0, 0, 0, 0]} />
                                                <Bar dataKey="80-90%" stackId="a" fill="#22c55e" radius={[0, 0, 0, 0]} />
                                                <Bar dataKey="90-100%" stackId="a" fill="#15803d" radius={[4, 4, 0, 0]} />
                                            </BarChart>
                                        </ResponsiveContainer>
                                    </div>
                                </div>
